...
public class DevRant {
    ...
    public static Rant[] getRants(Sort sort, int limit, int skip) {
        ...
        return Util.jsonToList(json.get("rants").getAsJsonArray(), new Function<JsonElement, Object>() {
            @Override
            public Object apply(JsonElement elem) {
                return Rant.fromJson(elem.getAsJsonObject());
            }
        }).toArray(new Rant[0]);
    }
    ...
    public static Rant[] search(String term) {
        ...
        return Util.jsonToList(json.get("results").getAsJsonArray(), new Function<JsonElement, Object>() {
            @Override
            public Object apply(JsonElement elem) {
                return Rant.fromJson(elem.getAsJsonObject());
            }
